...
VALUES (1, 'David', 'Koschnik', 'e_koschnick@doz.hwr-berlin.de', 1, 'IT-Projektmanager', 'Enterprise Systems', 'INTERN', 'ACTIVE', '2025-05-01', '2025-05-01', 3); -- test employee
...
VALUES   
    ('Noah', 'Kania', 's_kania22@stud.hwr-berlin.de', 1, 'Senior Developer', 'IT', 'FULL_TIME', 'ACTIVE', '2025-03-01', DATE_ADD(CURDATE(), INTERVAL 0 DAY), 3), -- Noah
    ('Chris', 'Bonitzki', 's_bonitzki22@stud.hwr-berlin.de', 1, 'Senior Business Architect', 'Enterprise Systems', 'FULL_TIME', 'ACTIVE', '2025-03-01', DATE_ADD(CURDATE(), INTERVAL 0 DAY), 3), -- Chris
    ('Nathan', 'Brendler', 's_brendler22@stud.hwr-berlin.de', 1, 'Senior Business Architect', 'Enterprise Systems', 'FULL_TIME', 'ACTIVE', '2025-03-01', DATE_ADD(CURDATE(), INTERVAL 0 DAY), 3), -- Janis
    ('Janis', 'Grüttmüller', 's_gruettmueller22@stud.hwr-berlin.de', 1, 'Senior Developer', 'IT', 'FULL_TIME', 'ACTIVE', '2025-03-01', DATE_ADD(CURDATE(), INTERVAL 0 DAY), 3), -- Nathan
    ('Svea', 'von Popowski', 'sveavonpopowski@yahoo.de', 1, 'Ganz tolle Freundin', 'Hab dich lieb Abteilung', 'FULL_TIME', 'ACTIVE', '2025-03-01', DATE_ADD(CURDATE(), INTERVAL 0 DAY), 3); -- Svea
